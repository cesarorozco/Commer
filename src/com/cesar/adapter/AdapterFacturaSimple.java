...
public class AdapterFacturaSimple extends ArrayAdapter<Factura> {
	 ...
	 */
	public AdapterFacturaSimple(Context context, List<Factura> datos) {
	...
	public View getView(  final int position, View convertView, ViewGroup parent) {
		// En primer lugar "inflamos" una nueva vista, que será la que se
				...
				direccion.setText(datos.get(position).getCliente().getDireccion());
