...
public class AdapterGastos extends ArrayAdapter<Gasto> {
	 ...
	 */
	public AdapterGastos(Context context, List<Gasto> datos) {
	...
	public View getView(  final int position, View convertView, ViewGroup parent) {
		// En primer lugar "inflamos" una nueva vista, que será la que se
				...
				nombre.setText(datos.get(position).getDetalle());
				...
				direccion.setText(DecimalFormat.getInstance().format(datos.get(position).getValor()));
